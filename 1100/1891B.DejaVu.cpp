...
void solve()
{
    // if current element is divisible by 2^xi, after adding 2^(xi-1), it won't be divisible by any 2^yi for all yi>=xi
    ll n, k, mini = INT_MAX;
    cin >> n >> k;
    VEC v(n), v1;
    FOR(i, n)
