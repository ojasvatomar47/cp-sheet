...
void solve()
{
    // just remove as many multiples as we can for any number which is not included in the set T
    // brute force - n*logn
    ll n, ans = 0;
    cin >> n;
    string str;
    ...
    // for marking which numbers are already handled (deleted) and no need to handle them now
    VEC mark(n, 0);
